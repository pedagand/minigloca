...
\begin{notation}
	...
	De plus, si $s \in Stm$ une déclaration, on notera $\reduced{s}{\mathcal{L}}{Skip}$ cette même déclaration, 
...
\begin{center}
	...
	5 & $\sskip$ & $\{a_3, a_4, a_6, b_6\}$ & $\{a_3, a_4, a_6, b_6, c_6\}$\\
	- & done & - & -\\
	6 & d := a * b * c & $\{a_6, b_6, c_6\}$ & $\emptyset$\\
	\hline
	\end{tabular}
